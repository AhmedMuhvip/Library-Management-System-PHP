            ...
            <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
                ...
                <form class="space-y-4 md:space-y-6" action="../controllers/login_contr.php" method="GET">
                    ...
                    <div class="flex items-center justify-between">
                        ...
                        <a href="#" class="text-sm font-medium text-blue-600 hover:text-blue-700 hover:underline transition-colors duration-200 dark:text-blue-500 dark:hover:text-blue-400">
                            Forgot password?
                        </a>                    </div>
                    <button type="submit" class="w-full text-white bg-blue-600 hover:bg-blue-700 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-6 py-3 text-center transition-transform transform hover:scale-105 shadow-lg hover:shadow-xl dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                        ...
                        Don’t have an account yet? <a href="../views/signup_view.php" target="_blank" class="font-medium text-primary-600 hover:underline dark:text-primary-500">Sign up</a>
                    </p>
                </form>
            </div>
        </div>
